...
func SetApiRouter(router *gin.Engine) {
	...
	anonymousRequestBodyLimit := middleware.AnonymousRequestBodyLimit()
	{
		...
		apiRouter.GET("/home_info_cards", controller.GetHomeInfoCards)
		...
		logRoute.GET("/usage_summary", middleware.UserAuth(), controller.GetLogsUsageSummary)
		logRoute.GET("/self/usage_summary", middleware.UserAuth(), controller.GetLogsSelfUsageSummary)
